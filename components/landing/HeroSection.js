    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
          <Link
            href="/login"
            className="group inline-flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold px-8 py-4 rounded-2xl text-base shadow-xl shadow-indigo-300/40 hover:shadow-2xl hover:shadow-indigo-400/50 hover:scale-105 transition-all duration-300"
          >
            Get Started Free
          ...
          <Link
            href="/login"
            className="inline-flex items-center gap-2 bg-white/70 backdrop-blur-sm text-slate-700 font-semibold px-8 py-4 rounded-2xl text-base border border-white/80 shadow-md hover:bg-white hover:shadow-lg transition-all duration-300"
          >
            Login to Dashboard
          </Link>
        </div>
        ...
        <p className="text-xs text-slate-400 font-medium pt-2">
          ✓ No credit card required &nbsp;&nbsp; ✓ Free forever plan &nbsp;&nbsp; ✓ Used by 10,000+ students
        </p>
      </div>
